...
#Crear profesor - INSERT
    def registrarProfesor(self, id_profesor, nombre, apellido, fecha_nacimiento, telefono, direccion, sexo, email, academia):
...
#Modificar profesor - UPDATE
def modificarProfesor(self, id_profesor, nombre, apellido, fecha_nacimiento, telefono, direccion, sexo, email, academia):
        if self.conexion.is_connected():
            try:
                cursor = self.conexion.cursor()
